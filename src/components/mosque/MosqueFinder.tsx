        ...
        <div ref={searchRef} className="relative mb-3">
          ...
          {searchQuery.length > 0 && (
            <button
              ...
              aria-label="Hapus pencarian kota"
              className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full p-1.5 text-slate-400 hover:bg-slate-200 hover:text-slate-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-400 dark:text-slate-500 dark:hover:bg-slate-700 dark:hover:text-slate-300"
            >
              <XIcon size={14} />
            </button>
          )}
